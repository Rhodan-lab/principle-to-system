...
SOURCES = {
    "17-materials-manufacturing": r"""1. Callister, W. D., and Rethwisch, D. G. *Materials Science and Engineering: An Introduction*. https://www.wiley.com/en-us/Materials+Science+and+Engineering%3A+An+Introduction%2C+10th+Edition-p-9781119405498
...
6. Pelin, G., et al. *The Use of Additive Manufacturing Techniques in the Development of Polymer-Based Composites*. https://www.mdpi.com/2073-4360/16/8/1055""",
    "18-semiconductors-electronics": r"""1. Massachusetts Institute of Technology OpenCourseWare. *Integrated Microelectronic Devices*. https://ocw.mit.edu/courses/6-720j-integrated-microelectronic-devices-spring-2007/
...
6. Postek, M. T., and Bennett, M. H. *Critical Dimension and Overlay Metrology*. https://www.nist.gov/publications/critical-dimension-and-overlay-metrology""",
    "19-software-ai": r"""1. Shannon, C. E. *A Mathematical Theory of Communication*. https://doi.org/10.1002/j.1538-7305.1948.tb01338.x
...
7. Internet Engineering Task Force. *RFC 9293: Transmission Control Protocol*. https://www.rfc-editor.org/info/rfc9293/""",
    "20-sensors-control-infrastructure": r"""1. WPILib Contributors. *Introduction to State-Space Control*. https://docs.wpilib.org/en/stable/docs/software/advanced-controls/state-space/state-space-intro.html
...
BOUNDARIES = {
    "17-materials-manufacturing": r"""## Phase 9 review boundaries and validity limits
...
""",
    "18-semiconductors-electronics": r"""## Phase 9 review boundaries and validity limits
...
""",
    "19-software-ai": r"""## Phase 9 review boundaries and validity limits
...
""",
    "20-sensors-control-infrastructure": r"""## Phase 9 review boundaries and validity limits
...
SECTION_REPLACEMENTS = {
    ("technology/17-materials-manufacturing/overview.md", 3): r"""## 3. Essential concepts
...
""",
    ("technology/17-materials-manufacturing/overview.md", 4): r"""## 4. Mechanisms and causal chains
...
""",
    ("technology/17-materials-manufacturing/overview.md", 5): r"""## 5. Important quantities
...
""",
    ("technology/17-materials-manufacturing/overview.md", 8): r"""## 8. Assumptions and approximations
...
""",
    ("technology/17-materials-manufacturing/overview.md", 10): r"""## 10. Common misconceptions
...
""",
    ("technology/17-materials-manufacturing/overview.md", 11): r"""## 11. Connections to other modules
...
""",
    ("technology/17-materials-manufacturing/technology.md", 6): r"""## 6. System architecture
...
""",
    ("technology/17-materials-manufacturing/technology.md", 8): r"""## 8. Performance and efficiency
...
""",
    ("technology/17-materials-manufacturing/technology.md", 10): r"""## 10. Safety principles
...
""",
    ("technology/17-materials-manufacturing/technology.md", 11): r"""## 11. Environmental and lifecycle considerations
...
""",
    ("technology/17-materials-manufacturing/explore.md", 1): r"""## 1. Observation prompts
...
""",
    ("technology/17-materials-manufacturing/explore.md", 2): r"""## 2. Prediction questions
...
""",
    ("technology/17-materials-manufacturing/explore.md", 3): r"""## 3. Worked reasoning examples
...
""",
    ("technology/17-materials-manufacturing/explore.md", 5): r"""## 5. Household and browser-based explorations
...
""",
    ("technology/17-materials-manufacturing/explore.md", 6): r"""## 6. Model-building prompts
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 3): r"""## 3. Essential concepts
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 4): r"""## 4. Mechanisms and causal chains
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 5): r"""## 5. Important quantities
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 6): r"""## 6. Mathematical models and equations
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 8): r"""## 8. Assumptions and approximations
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 10): r"""## 10. Common misconceptions
...
""",
    ("technology/18-semiconductors-electronics/overview.md", 11): r"""## 11. Connections to other modules
...
""",
    ("technology/18-semiconductors-electronics/technology.md", 5): r"""## 5. Matter, energy, force, or information flow
...
""",
    ("technology/18-semiconductors-electronics/technology.md", 7): r"""## 7. Design constraints
...
""",
    ("technology/18-semiconductors-electronics/technology.md", 8): r"""## 8. Performance and efficiency
...
""",
    ("technology/18-semiconductors-electronics/technology.md", 10): r"""## 10. Safety principles
...
""",
    ("technology/18-semiconductors-electronics/technology.md", 11): r"""## 11. Environmental and lifecycle considerations
...
""",
    ("technology/18-semiconductors-electronics/explore.md", 2): r"""## 2. Prediction questions
...
""",
    ("technology/18-semiconductors-electronics/explore.md", 3): r"""## 3. Worked reasoning examples
...
""",
    ("technology/18-semiconductors-electronics/explore.md", 5): r"""## 5. Household and browser-based explorations
...
""",
    ("technology/19-software-ai/overview.md", 2): r"""## 2. Observable phenomena
...
""",
    ("technology/19-software-ai/overview.md", 3): r"""## 3. Essential concepts
...
""",
    ("technology/19-software-ai/overview.md", 4): r"""## 4. Mechanisms and causal chains
...
""",
    ("technology/19-software-ai/overview.md", 5): r"""## 5. Important quantities
...
""",
    ("technology/19-software-ai/overview.md", 6): r"""## 6. Mathematical models and equations
...
""",
    ("technology/19-software-ai/overview.md", 8): r"""## 8. Assumptions and approximations
...
""",
    ("technology/19-software-ai/overview.md", 10): r"""## 10. Common misconceptions
...
""",
    ("technology/19-software-ai/technology.md", 3): r"""## 3. Main components
...
""",
    ("technology/19-software-ai/technology.md", 5): r"""## 5. Matter, energy, force, or information flow
...
""",
    ("technology/19-software-ai/technology.md", 6): r"""## 6. System architecture
...
""",
    ("technology/19-software-ai/technology.md", 7): r"""## 7. Design constraints
...
""",
    ("technology/19-software-ai/technology.md", 8): r"""## 8. Performance and efficiency
...
""",
    ("technology/19-software-ai/technology.md", 9): r"""## 9. Reliability and failure modes
...
""",
    ("technology/19-software-ai/technology.md", 10): r"""## 10. Safety principles
...
""",
    ("technology/19-software-ai/explore.md", 1): r"""## 1. Observation prompts
...
""",
    ("technology/19-software-ai/explore.md", 2): r"""## 2. Prediction questions
...
""",
    ("technology/19-software-ai/explore.md", 4): r"""## 4. Thought experiments
...
""",
    ("technology/19-software-ai/explore.md", 5): r"""## 5. Household and browser-based explorations
...
""",
    ("technology/19-software-ai/explore.md", 10): r"""## 10. Reasoning notes
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 3): r"""## 3. Essential concepts
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 4): r"""## 4. Mechanisms and causal chains
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 5): r"""## 5. Important quantities
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 6): r"""## 6. Mathematical models and equations
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 8): r"""## 8. Assumptions and approximations
...
""",
    ("technology/20-sensors-control-infrastructure/overview.md", 10): r"""## 10. Common misconceptions
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 4): r"""## 4. How the components interact
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 6): r"""## 6. System architecture
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 8): r"""## 8. Performance and efficiency
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 9): r"""## 9. Reliability and failure modes
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 10): r"""## 10. Safety principles
...
""",
    ("technology/20-sensors-control-infrastructure/technology.md", 11): r"""## 11. Environmental and lifecycle considerations
...
""",
    ("technology/20-sensors-control-infrastructure/explore.md", 1): r"""## 1. Observation prompts
...
""",
    ("technology/20-sensors-control-infrastructure/explore.md", 3): r"""## 3. Worked reasoning examples
...
""",
    ("technology/20-sensors-control-infrastructure/explore.md", 5): r"""## 5. Household and browser-based explorations
...
""",
    ("technology/20-sensors-control-infrastructure/explore.md", 10): r"""## 10. Reasoning notes
